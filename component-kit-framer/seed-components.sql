...
insert into components (id, name, category, is_pro, preview_svg, tsx_source, file_name, sort_order) values (
  ...
  '<svg viewBox="0 0 200 84"><rect width="200" height="84" fill="none"/>
      <rect x="70" y="14" width="60" height="4" rx="2" fill="#4a5aff"/>
      <rect x="40" y="26" width="120" height="8" rx="2" fill="#1a1a1c"/>
      <rect x="55" y="40" width="90" height="6" rx="2" fill="#b8b8bc"/>
      <rect x="75" y="56" width="50" height="16" rx="8" fill="#4a5aff"/>
    </svg>',
...
insert into components (id, name, category, is_pro, preview_svg, tsx_source, file_name, sort_order) values (
  ...
  '<svg viewBox="0 0 200 84"><rect x="10" y="30" width="180" height="24" rx="6" fill="none" stroke="var(--border)"/>
      <rect x="20" y="38" width="30" height="8" rx="2" fill="#1a1a1c"/>
      <rect x="80" y="40" width="20" height="4" rx="2" fill="#b8b8bc"/>
      <rect x="108" y="40" width="20" height="4" rx="2" fill="#b8b8bc"/>
      <rect x="150" y="37" width="30" height="10" rx="5" fill="#4a5aff"/>
    </svg>',
  'import { addPropertyControls, ControlType } from "framer"
...
insert into components (id, name, category, is_pro, preview_svg, tsx_source, file_name, sort_order) values (
  ...
  '<svg viewBox="0 0 200 84"><rect x="60" y="6" width="80" height="72" rx="8" fill="none" stroke="var(--border)"/>
      <rect x="70" y="16" width="20" height="5" rx="2" fill="#4a5aff"/>
      <rect x="70" y="26" width="40" height="12" rx="2" fill="#1a1a1c"/>
      <rect x="70" y="46" width="45" height="4" rx="2" fill="#b8b8bc"/>
      <rect x="70" y="54" width="45" height="4" rx="2" fill="#b8b8bc"/>
      <rect x="70" y="64" width="60" height="10" rx="5" fill="#4a5aff"/>
    </svg>',
  'import { addPropertyControls, ControlType } from "framer"
...
insert into components (id, name, category, is_pro, preview_svg, tsx_source, file_name, sort_order) values (
  ...
  '<svg viewBox="0 0 200 84"><rect x="30" y="8" width="140" height="68" rx="10" fill="none" stroke="var(--border)"/>
      <rect x="42" y="20" width="116" height="5" rx="2" fill="#b8b8bc"/>
      <rect x="42" y="30" width="90" height="5" rx="2" fill="#b8b8bc"/>
      <circle cx="52" cy="58" r="8" fill="#4a5aff" opacity="0.35"/>
      <rect x="66" y="54" width="40" height="4" rx="2" fill="#1a1a1c"/>
      <rect x="66" y="61" width="55" height="4" rx="2" fill="#b8b8bc"/>
    </svg>',
  'import { addPropertyControls, ControlType } from "framer"
...
insert into components (id, name, category, is_pro, preview_svg, tsx_source, file_name, sort_order) values (
  ...
  '<svg viewBox="0 0 200 84"><rect x="55" y="10" width="90" height="64" rx="8" fill="none" stroke="var(--border)"/>
      <rect x="65" y="20" width="18" height="18" rx="5" fill="#4a5aff" opacity="0.35"/>
      <rect x="65" y="46" width="50" height="6" rx="2" fill="#1a1a1c"/>
      <rect x="65" y="56" width="65" height="4" rx="2" fill="#b8b8bc"/>
      <rect x="65" y="63" width="55" height="4" rx="2" fill="#b8b8bc"/>
    </svg>',
  'import { addPropertyControls, ControlType } from "framer"
...
insert into components (id, name, category, is_pro, preview_svg, tsx_source, file_name, sort_order) values (
  ...
  'Sections',
  false,
  '<svg viewBox="0 0 200 84"><rect x="20" y="24" width="160" height="36" rx="8" fill="#1a1a1c"/>
      <rect x="32" y="35" width="60" height="6" rx="2" fill="white"/>
      <rect x="32" y="44" width="80" height="4" rx="2" fill="#b8b8bc"/>
...
insert into components (id, name, category, is_pro, preview_svg, tsx_source, file_name, sort_order) values (
  ...
  '<svg viewBox="0 0 200 84">
      <rect x="20" y="12" width="24" height="4" rx="2" fill="#1a1a1c"/>
      <rect x="20" y="20" width="18" height="3" rx="1.5" fill="#b8b8bc"/>
      <rect x="20" y="26" width="18" height="3" rx="1.5" fill="#b8b8bc"/>
      <rect x="90" y="12" width="24" height="4" rx="2" fill="#1a1a1c"/>
      <rect x="90" y="20" width="18" height="3" rx="1.5" fill="#b8b8bc"/>
      <rect x="90" y="26" width="18" height="3" rx="1.5" fill="#b8b8bc"/>
      <rect x="160" y="12" width="20" height="4" rx="2" fill="#1a1a1c"/>
      <rect x="160" y="20" width="16" height="3" rx="1.5" fill="#b8b8bc"/>
      <line x1="20" y1="48" x2="180" y2="48" stroke="var(--border)"/>
      <rect x="20" y="58" width="50" height="4" rx="2" fill="#b8b8bc"/>
      <rect x="140" y="58" width="40" height="4" rx="2" fill="#b8b8bc"/>
    </svg>',
  'import { addPropertyControls, ControlType } from "framer"
...
insert into components (id, name, category, is_pro, preview_svg, tsx_source, file_name, sort_order) values (
  ...
  '<svg viewBox="0 0 200 84">
        ...
        <rect x="15" y="30" width="40" height="10" rx="2" fill="#1a1a1c"/>
        <rect x="20" y="46" width="30" height="4" rx="2" fill="#b8b8bc"/>
      
        <rect x="80" y="30" width="40" height="10" rx="2" fill="#1a1a1c"/>
        <rect x="85" y="46" width="30" height="4" rx="2" fill="#b8b8bc"/>
      
        <rect x="145" y="30" width="40" height="10" rx="2" fill="#1a1a1c"/>
        <rect x="150" y="46" width="30" height="4" rx="2" fill="#b8b8bc"/>
